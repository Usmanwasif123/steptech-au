...
const Navbar = () => {
  ...
  return (
    <>
    <div className='blockchain-nav-container'>
        ...
        <li><Link to='/'>home</Link></li>
           ...
           <KeyboardArrowDownOutlined style={{position:'absolute', zIndex: 1, fontSize: '25px', top: '320%', left: '73.4px', color: "#fff"}}/>
            <Link to='/service' className='service' style={{marginTop: '13px'}}>services</Link>
            {isDropdownOpen && 
      ...
      <button className='blockchain1-start' onClick={() => setIsVisible(true)}  data-aos="flip-right" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0">get started</button>
      {isVisible && 
        <div className='block1-visible-div'>
      ...
      <div className='block-nav-image'></div>
    </div>
   </>
  );
}
