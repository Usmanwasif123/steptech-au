...
const Partner = () => {
  ...
  return (
    <div className={`smm-section7 ${isOpen ? 'open' : ''}`} style={containerStyles}>
        <h1>Best Web and App Development Company in &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wyoming, USA</h1>
        <div id='line-smm' style={lineStyle}></div>
        ...
        <button  style={btnStyle} className={`smmbtn-read`} onClick={()=> setIsOpen(!isOpen)}>{isOpen ? 'read less': 'read more'}</button>
    </div>
  )
}
