...
const Navbar = () => {
  ...
  return (
    ...
    <div className='smm-nav-container'>
      ...
      <button className='smmbtn1-start' onClick={() => setIsVisible(true)}  data-aos="flip-right" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0">get started</button>
      {isVisible && 
        <div className='smm1-visible-div'>
      ...
      <div className='smm-nav-image' ></div>
    </div>
   </>
  );
}
