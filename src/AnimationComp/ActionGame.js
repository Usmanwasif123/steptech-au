...
import '../assets/AnimationWrapper/Actiongame.css';
...
const ActionGame = () => {
  return (
    <div className='animate-section1'>
      ...
      <div className='animate-img1' data-aos="slide-left" data-aos-duration="600" data-aos-easing="ease-in-sine" data-aos-offset="0"></div>
    </div>
  )
}
