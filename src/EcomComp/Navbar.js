...
import '../assets/EcomWrapper/Navbar.css';
...
const Navbar = () => {
  ...
  return (
    ...
    <div className='ecom-nav-container'>
      ...
      <button className='ecombtn1-start' onClick={() => setIsVisible(true)}  data-aos="flip-right" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0">get started</button>
      {isVisible && 
        <div className='ecom1-visible-div'>
      ...
      <div className='ecom-nav-image' data-aos="slide-left" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0"></div>
    </div>
   </>
  );
}
