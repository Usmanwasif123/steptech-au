...
import '../assets/EcomWrapper/Partner.css';
...
const Partner = () => {
  ...
  return (
    <div className={`ecom-section7 ${isOpen ? 'open' : ''}`} style={containerStyles}>
        <h1>Best Web and App Development Company in &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wyoming, USA</h1>
        <div id='line-ecom' style={lineStyle}></div>
        ...
        <button style={btnStyles} className={`ecombtn-read ${isOpen ? 'open' : ''}`} onClick={()=> setIsOpen(!isOpen)}>{isOpen ? 'read less': 'read more'}</button>
    </div>
  )
}
