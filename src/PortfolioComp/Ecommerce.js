...
import '../assets/PortWrapper/Ecommerce.css';
      ...
      <div className='port-carousel'>
          <Slider {...setting}>
            <div className='port-card1'>
                <img className='img1' src='https://i.ibb.co/Gc6mbTf/image.png' alt='ai'/>
            </div> 
            <div className='port-card2'> 
                <img className='img2' src='https://i.ibb.co/h8ZvY07/image.png' alt='ai'/>
            </div>
            <div className='port-card3'>
                <img className='img3' src='https://i.ibb.co/tL1vNzx/image.png' alt='ai'/>
            </div> 
          </Slider>
          </div>
    </div>
