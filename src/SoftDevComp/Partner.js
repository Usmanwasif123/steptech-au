...
import '../assets/SoftDevWrapper/Partner.css';
...
const Partner = () => {
  ...
  return (
    <div className={`soft-section6 ${isOpen ? 'open' : ''}`} style={containerStyles}>
        <h1>Best Web and App Development Company in &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wyoming, USA</h1>
        <div id='line-soft' style={lineStyle}></div>
        ...
        <button style={btnStyles} className={`softbtn-read`} onClick={()=> setIsOpen(!isOpen)}>{isOpen ? 'read less': 'read more'}</button>
    </div>
  )
}
