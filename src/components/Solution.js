...
const Solution = () => {
  return (
    <div className='solution-container'>
        ...
        <div class="face1"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="python" class="svg-inline--fa fa-python " role="img" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 448 512" color="#4B8BBE">
        ...
        <div class="face2"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="html5" class="svg-inline--fa fa-html5 " role="img" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 384 512" color="#F06529">
        ...
        <div class="face3"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="css3" class="svg-inline--fa fa-css3 " role="img" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 512 512" color="#28A4D9">
        <path fill="currentColor" d="M480 32l-64 368-223.3 80L0 400l19.6-94.8h82l-8 40.6L210 390.2l134.1-44.4 18.8-97.1H29.5l16-82h333.7l10.5-52.7H56.3l16.3-82H480z"></path></svg></div>
        <div class="face4"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="react" class="svg-inline--fa fa-react " role="img" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 512 512" color="#5ED4F4">
        ...
        <div class="face5"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="js-square" class="svg-inline--fa fa-js-square " role="img" xmlns="http://www.w3.org/2000/svg" width="100" height="100"  viewBox="0 0 448 512" color="#EFD81D">
        ...
        <div class="face6"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="git-alt" class="svg-inline--fa fa-git-alt " role="img" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 448 512" color="#EC4D28">
        <path fill="currentColor" d="M439.5 236.1L244 40.45a28.87 28.87 0 0 0 -40.81 0l-40.66 40.63 51.52 51.52c27.06-9.14 52.68 16.77 43.39 43.68l49.66 49.66c34.23-11.8 61.18 31 35.47 56.69-26.49 26.49-70.21-2.87-56-37.34L240.2 199v121.8c25.3 12.54 22.26 41.85 9.08 55a34.34 34.34 0 0 1 -48.55 0c-17.57-17.6-11.07-46.91 11.25-56v-123c-20.8-8.51-24.6-30.74-18.64-45L142.6 101 8.45 235.1a28.86 28.86 0 0 0 0 40.81l195.6 195.6a28.86 28.86 0 0 0 40.8 0l194.7-194.7a28.86 28.86 0 0 0 0-40.81z">
        </path>
        </svg>
        </div>
        </div>
