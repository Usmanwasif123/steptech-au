          ...
          <Slider {...setting}>
            <div className='card1'>
              <img className='circle1' src='https://i.ibb.co/1QnZmL0/circle.png'/>
                ...
                <p className='p1-f'>Lorem Ipsum is simply dummy text of the <br/>printing and 
            ...
            <div className='card2'>
              ...
              <img className='ai' src='https://i.ibb.co/L85bTDp/image.png' alt='ai' /> 
                ...
                <p className='p2-g'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div>
            <div className='card3'>
            ...
            <img className='ai' src='https://i.ibb.co/c1zmjbq/image.png' alt='ai' />  
                ...
                <p className='p3-w'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
            <div className='card4'>
            ...
            <img className='ai' src='https://i.ibb.co/TBCTC94/image.png' alt='ai' />
                ...
                <p className='p4-a'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div>  
            <div className='card5'>
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />               
                ...
                <p className='p5-b'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
            <div className='card6'>
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />               
                ...
                <p className='p6-c'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div>
            <div className='card7'>
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />             
                ...
                <p className='p7-d'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
              standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
            <div className='card8'>
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />            
                ...
                <p className='p8-e'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div>
            <div className='card9'>
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />            
                ...
                <p className='p9-e'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />            
                ...
                <p className='p10-e'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />            
                ...
                <p className='p11-e'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />            
                ...
                <p className='p12-e'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
            ...
            <img className='ai' src='https://i.ibb.co/m6Cw4yy/image.png' alt='ai' />            
                ...
                <p className='p13-e'>Lorem Ipsum is simply dummy text of the <br/>printing and 
                typesetting industry. Lorem Ipsum <br/>has been the industry's 
                standard dummy text <br/>ever since the 1500s, when an unknown</p>
            </div> 
          </Slider>
