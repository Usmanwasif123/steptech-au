      ...
      <Row>
        <Col>
          <div 
            ...
            style={{ marginTop: '5rem', marginLeft: '0rem', position: 'absolute', display: 'inline-block', width: '41rem', height: '23rem'}}>
            <Card style={{ background: '#fff', height: '20rem', width: '38rem', marginLeft: '3rem', zIndex: '0', borderRadius: '0.5rem', overflow: 'hidden'}}>
              <img style={{ width: '100%', height: 'auto', objectFit: 'cover', borderRadius: '0.5rem', transition: 'transform 0.5s ease', zIndex: 1, position: 'relative'}} src='https://i.ibb.co/L9XHDX2/image.png' alt='card-img'/>
              <canvas id="water-effect" width="893" height="607"></canvas>
            </Card>
