    ...
    <div className='footer-container'>
      ...
      <Facebook style={{position: 'absolute', zIndex: '3', top: '85%', left: '1.5%',
        ...
        <div className='service-links'>
            ...
            <li><Link to='/graphic-designing'>Graphics Designing</Link></li>
            <li><Link to='/web-design-and-development'>Website Design & 
            Development</Link></li>
            <li><Link to='/app-development'>Mobile App UI/UX Design &<br/>
             Development</Link></li>
        ...
        <div className='service-links2'>
            ...
            <li><Link to='/game-design-and-development'>Game Design & Development
            </Link>
            </li>
            <li><Link to='/2D/3D-Animation'>2D/3D Animation</Link>
            </li>
            <li><Link to='/block-chain-development'>Block Chain Development</Link>
            </li>
            <li><Link to='/nft'>NFT</Link>
            </li>
            <li><Link to='/artificial-intelligence-development'>Artificial Intelligence</Link>
            </li>
            </nav>
        </div>
