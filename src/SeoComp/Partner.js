...
import '../assets/SeoWrapper/Partner.css';
...
const Partner = () => {
  ...
  return (
    <div className={`seo-section7 ${isOpen ? 'open' : ''}`} style={containerStyles}>
        <h1>Best Web and App Development Company in &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wyoming, USA</h1>
        <div id='line-seo'  style={lineStyle}></div>
        ...
        <button className={`seobtn-read ${isOpen ? 'open' : ''}`} onClick={()=> setIsOpen(!isOpen)}>{isOpen ? 'read less': 'read more'}</button>
    </div>
  )
}
