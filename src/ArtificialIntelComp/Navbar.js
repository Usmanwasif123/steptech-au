  ...
  return (
    ...
    <div className='ai-nav-container'>
        ...
        <li><Link to='/'>home</Link></li>
           ...
           <KeyboardArrowDownOutlined style={{position:'absolute', zIndex: 1, fontSize: '25px', top: '310%', left: '73.4px', color: "#fff"}}/>
      ...
      <button className='aibtn-start' onClick={() => setIsVisible(true)}  data-aos="flip-right" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0">get started</button>
      {isVisible && 
        <div className='ai1-visible-div'>
