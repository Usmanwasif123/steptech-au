...
import '../assets/BlogWrapper/Navbar.css';
  ...
  return (
    ...
    <div className='blog-nav-container'>
        ...
        <li className='dropdown' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
           <KeyboardArrowDownOutlined style={{position:'absolute', zIndex: 1, fontSize: '25px', top: '2.68rem', left: '4.7rem', color: "#fff"}}/>
            <Link to='/service' className='service' style={{marginTop: '-1.125rem'}}>services</Link>
            {isDropdownOpen && 
      ...
      <div className='blog-banner-line'></div>
