...
import '../assets/ServiceWrapper/Partner.css';
...
const Partner = () => {
  return (
    <div className='service-section7'>
      ...
      <div className='service-left7' data-aos="slide-right" data-aos-duration="600" data-aos-easing="ease-in-sine" data-aos-offset="0"></div>
      <div className='service-right7' data-aos="slide-left" data-aos-duration="600" data-aos-easing="ease-in-sine" data-aos-offset="0"></div>
    </div>
  )
}
