...
import '../assets/ServiceWrapper/Process.css';
...
const Process = () => {
  return (
    <div className='service-section6'>
      ...
      <div className='service-left6' data-aos="slide-right" data-aos-duration="600" data-aos-easing="ease-in-sine" data-aos-offset="0"></div>
      <div className='service-right6' data-aos="slide-left" data-aos-duration="600" data-aos-easing="ease-in-sine" data-aos-offset="0"></div>
    </div>
  )
}
