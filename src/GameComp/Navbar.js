...
const Navbar = () => {
  ...
  return (
    ...
    <div className='game-nav-container'>
      ...
      {isVisible && 
        <div className='game-visible-div'>
      ...
      <div className='gamenav-image' data-aos="slide-left" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0"></div>
    </div>
   </>
  );
}
