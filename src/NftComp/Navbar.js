  ...
  return (
    ...
    <div className='nft-nav-container'>
        ...
        <li><Link to='/'>home</Link></li>
           ...
           <KeyboardArrowDownOutlined style={{position:'absolute', zIndex: 1, fontSize: '25px', top: '300%', left: '73.4px', color: "#fff"}}/>
            <Link to='/service' className='service' style={{marginTop: '10px'}}>services</Link>
            {isDropdownOpen && 
      ...
      <button className='nftbtn-start' onClick={() => setIsVisible(true)}  data-aos="flip-right" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0">get started</button>
      {isVisible && 
        <div className='nft1-visible-div'>
