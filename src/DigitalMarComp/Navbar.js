...
const Navbar = () => {
  ...
  return (
    ...
    <div className='digi-nav-container'>
      ...
      <button className='digibtn1-start' onClick={() => setIsVisible(true)}  data-aos="flip-right" data-aos-duration="500" data-aos-easing="ease-in-sine" data-aos-offset="0">get started</button>
      {isVisible && 
        <div className='digi1-visible-div'>
